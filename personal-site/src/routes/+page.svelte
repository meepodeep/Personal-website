...
<button
        ...
        on:mouseenter={onHoverProjects}
        on:mouseleave={onLeave}
        class = "bg-amber-50 absolute top-1/2 left-4/6 transform -translate-x-2/6 -translate-y-3/5 w-40 h-45 opacity-10 sm:hidden"
        >
        projects
    </button>
<!--About button-->
...
<button
        ...
        on:mouseenter={onHoverAbout}
        on:mouseleave={onLeave}
        class = "bg-amber-50 absolute top-4/9 left-1/4 transform -translate-x-1/2 -translate-y-1/4 w-80 h-75 opacity-10 sm:hidden"
        >
        About
    </button>
<!--links button-->
...
<button
        ...
        on:mouseenter={onHoverLinks}
        on:mouseleave={onLeave}
        class = "bg-amber-50 absolute top-1/2 left-0/2 transform -translate-x-1/5 -translate-y-1/2 w-55 h-75 opacity-10 sm:hidden"
        >
        Links
    </button>
</main>
